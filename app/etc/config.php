...
return [
    'modules' => [
        ...
        'Training_TestOM' => 1,
        'Training_Arguments' => 1,
        'Training_ArgumentsOverride' => 0,
        'Training_Dependency' => 1,
        'Training_Dependency1' => 1,
        'Training_AdditionalDependency' => 1,
        'Training_AdditionalTestOM' => 0,
        'Training_ModifyTemplatePlugin' => 1,
        'Training_Plugins' => 0,
        'Training_Preference' => 1,
        'Training_PreferenceOverride' => 0,
        'Training_RedirectObserverProduct' => 1,
        'Training_RedirectUnloggedProductPlugin' => 0,
